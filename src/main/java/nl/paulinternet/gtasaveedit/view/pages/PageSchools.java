...
public class PageSchools extends Page
{
	public PageSchools () {
		...
		for (int i=0; i<12; i++) {
			...
			table.add(new ConnectedTextField(Model.vars.schoolDriving.get(i)), 2, 2+i);
		...
		for (int i=0; i<10; i++) {
			...
			table.add(new ConnectedTextField(Model.vars.schoolFlying.get(i)), 2, 15+i);
		...
		for (int i=0; i<5; i++) {
			...
			table.add(new ConnectedTextField(Model.vars.schoolBoat.get(i)), 2, 26+i);
		...
		for (int i=0; i<6; i++) {
			...
			table.add(new ConnectedTextField(Model.vars.schoolBike.get(i)), 2, 32+i);
