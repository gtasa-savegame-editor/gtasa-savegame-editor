...
public class PageAbout extends JFrame {
    ...
    public PageAbout() {
        ...
        repoButton.onClick().addHandler(this, "openWebsite", "git.k40s.net/lfuelling/gta-sa-savegame-editor");
        ...
        JLabel label = new JLabel(
                "<html>" +
                        ...
                        "<font size=+1>Version 3.3-mac (without 3d)</font><br />" +
                        "<br />" +
                        "This program is created by Paul Breeuwsma.<br />" +
                        "macOS tailored version by lrk.<br /><br />" +
                        "The original source code is available online.<br />" +
                        "The source code of <b>this</b> version can be accessed using the 'View Source' button.<br />" +
                        "<br />" +
