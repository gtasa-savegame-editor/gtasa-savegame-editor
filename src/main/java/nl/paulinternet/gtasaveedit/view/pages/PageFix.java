...
public class PageFix extends Page
{
	...
	public void fixBasketballGlitch () {
		Model.vars.basketballGlitch.setBooleanValue(false);
	...
	public void fixPoolPlayerGlitch () {
		Model.vars.poolPlayerGlitch.setBooleanValue(false);
	...
	public void onGameLoaded () {
		buttonBasketball.setEnabled(Model.vars.basketballGlitch.getBooleanValue());
		buttonSaveDisk.setEnabled(true);
		buttonPoolPlayer.setEnabled(Model.vars.poolPlayerGlitch.getBooleanValue());
		buttonTraffic.setEnabled(true);
		buttonGym.setEnabled(true);
		buttonZone.setEnabled(Model.vars.zoneGlitch.getBooleanValue());
		
		labelBasketball.setText(Model.vars.basketballGlitch.getBooleanValue() ? "Yes" : "No");
		labelPoolPlayer.setText(Model.vars.poolPlayerGlitch.getBooleanValue() ? "Yes" : "No");
		labelTraffic.setText("Unknown");
		labelGym.setText("Unknown");
		labelZone.setText(Model.vars.zoneGlitch.getBooleanValue() ? "Yes" : "No");
	}
}
