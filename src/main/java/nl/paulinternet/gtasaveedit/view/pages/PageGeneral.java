...
import nl.paulinternet.gtasaveedit.view.DisabledCheckbox;
import nl.paulinternet.gtasaveedit.view.ValueButton;
import nl.paulinternet.gtasaveedit.model.variables.VariableTime;
...
public class PageGeneral extends Page
{
	public PageGeneral () {
		...
		ConnectedComboBox versionBox = new ConnectedComboBox(Model.vars.version);
		...
		ConnectedRadioButtons buttonsScriptVersion = new ConnectedRadioButtons(Model.vars.scriptVersion);
		ConnectedRadioButtons buttonsCurrentIpl = new ConnectedRadioButtons(Model.vars.currentIplVersion);
		ConnectedRadioButtons buttonsConvertIpl = new ConnectedRadioButtons(Model.vars.convertIplVersion);
		...
		titlePanel.add(new ConnectedTextField(Model.vars.title), 1);
