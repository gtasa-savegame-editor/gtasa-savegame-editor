...
public class MenuBar extends JMenuBar
{
	...
	private static class CloseMenuItem extends JMenuItem implements ActionListener
	{
		public CloseMenuItem () {
			super("Close");
			setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_W, Main.MAC ? ActionEvent.META_MASK : ActionEvent.CTRL_MASK));
			addActionListener(this);
		}
	...
	private static class LoadCompleteSavegame extends JMenuItem implements ActionListener
	{
		public LoadCompleteSavegame () {
			...
			setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_9, Main.MAC ? ActionEvent.META_MASK : ActionEvent.CTRL_MASK));
			addActionListener(this);
		}
	...
	public static class OpenDirMenuItem extends JMenuItem implements ActionListener
	{
		public OpenDirMenuItem () {
			...
			setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, Main.MAC ? ActionEvent.META_MASK : ActionEvent.CTRL_MASK));
			addActionListener(this);
			settingsChanged();
