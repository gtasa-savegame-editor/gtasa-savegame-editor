...
public class FileSystem
{
	...
	public static File getSavegameDirectory () {
		switch (Settings.getSavegameDirectoryType()) {
			case Settings.DIR_DEFAULT: return getDefaultSavegameDirectory();
			case Settings.DIR_ACTIVE: return activeDir;
			case Settings.DIR_CUSTOM: return new File(Settings.getCustomSavegameDirectory());
	...
	public static File getSanAndreasDirectory () {
		switch (Settings.getSanAndreasDirectoryType()) {
			case Settings.DIR_DEFAULT: return detectedSaDir;
			case Settings.DIR_CUSTOM: return new File(Settings.getCustomSanAndreasDirectory());
			default: throw new IllegalStateException();
		}
	}
	
	public static File getSanAndreasExecutable () {
		File saDir = getSanAndreasDirectory();
