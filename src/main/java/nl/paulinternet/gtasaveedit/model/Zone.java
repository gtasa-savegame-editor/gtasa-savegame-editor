...
public class Zone
{
	...
	public static final int TRIADS = 6, AZTECAS = 7, DEALER = 0xa, POPCYCLE = 0xf, PED = 0x10;
	...
	public void setValue (int id, int value) {
		switch (id) {
			case POPCYCLE: popcycle = value; break;
			case PED: ped = value; break;
			case DEALER: dealer = value; break;
			case GANG_PRESENT: gangPresent = value != 0; break;
			case DISABLE_FOOTCOPS: disabledFootcops = value != 0; break;
			default: gang[id] = value; color = null; break;
		}
	}
	
	public int getValue (int id) {
		switch (id) {
			case POPCYCLE: return popcycle;
			case PED: return ped;
			case DEALER: return dealer;
			case GANG_PRESENT: return gangPresent ? 1 : 0;
			case DISABLE_FOOTCOPS: return disabledFootcops ? 1 : 0;
			default: return gang[id];
		}
	}
