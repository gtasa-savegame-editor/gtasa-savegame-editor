...
public class Block01 extends LinkArray
{
	...
	public void load (SavegameData io) throws FileFormatException {
		...
		switch (io.readInt(1, afterGlobalVars + 0x8f2)) {
			case 194146: version = 1; break;
			case 194125: version = 2; break;
			default: version = 0;
		}
		
		Model.vars.scriptVersion.setIntValue(version);
		Model.vars.scriptVersion.setEnabled(version != 0);
		Model.vars.scriptVersion.resetChangedState();
	...
	public void save (SavegameData io) {
		// Script version
		if (Model.vars.scriptVersion.hasChanged()) {
			int version = Model.vars.scriptVersion.getIntValue();
