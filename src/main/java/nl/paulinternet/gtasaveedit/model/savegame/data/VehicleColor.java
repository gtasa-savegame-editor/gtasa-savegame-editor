...
public class VehicleColor {
  ...
  static {
    colors = new ArrayList<VehicleColor>();

    colors.add(new VehicleColor(0, 0, 0, 0));
    colors.add(new VehicleColor(40, 34, 25, 24));
    colors.add(new VehicleColor(75, 32, 32, 44));
    colors.add(new VehicleColor(66, 52, 26, 30));
    colors.add(new VehicleColor(36, 37, 37, 39));
    colors.add(new VehicleColor(44, 25, 56, 38));
    colors.add(new VehicleColor(83, 30, 46, 50));
    colors.add(new VehicleColor(43, 95, 10, 21));
    colors.add(new VehicleColor(101, 31, 37, 59));
    colors.add(new VehicleColor(53, 22, 34, 72));
    colors.add(new VehicleColor(30, 66, 31, 33));
    colors.add(new VehicleColor(121, 98, 11, 28));
    colors.add(new VehicleColor(117, 100, 13, 27));
    colors.add(new VehicleColor(4, 38, 55, 57));
    colors.add(new VehicleColor(45, 93, 27, 32));
    colors.add(new VehicleColor(3, 132, 4, 16));
    colors.add(new VehicleColor(17, 115, 14, 26));
    colors.add(new VehicleColor(37, 45, 58, 53));
