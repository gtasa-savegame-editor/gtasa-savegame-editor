...
public class Garage {
    ...
    static {
        ...
        //FIXME: ids are obviously invalid
        ...
        garages.add(new Garage(0, new Location(319.326, -1768.93, 3.35686), "beacsv", "Santa Maria Beach garage"));
        ...
        garages.add(new Garage(0, new Location(1408.65, 1899.52, 10.115), "blob6", "Redsands West garage"));
        garages.add(new Garage(0, new Location(1269.2, 2525.14, 9.80013), "blob69", "Prickle Pine garage"));
        garages.add(new Garage(0, new Location(929.554, 2008.59, 10.115), "blob7", "Whitewood Estates garage"));
        ...
        garages.add(new Garage(0, new Location(783.155, -492.75, 16.3361), "burbdo2", "Dillimore garage"));
        garages.add(new Garage(0, new Location(2227.6, 168.649, 26.4635), "burbdoo", "Palomino Creek garage"));
        garages.add(new Garage(0, new Location(2738.4, -2012.55, 12.5759), "burg_lk", "Los Santos burglary garage"));
        garages.add(new Garage(0, new Location(1694.8, -2088.7, 12.3636), "carlas1", "El Corona garage"));
        garages.add(new Garage(0, new Location(1352.58, -636.657, 108.135), "CEsafe1", "Muholland garage"));
        garages.add(new Garage(0, new Location(715.806, -462.403, 14.9635), "CEspray", "Dillimore Pay n Spray"));
        garages.add(new Garage(0, new Location(2502.31, -1699.36, 12.4323), "cjsafe", "Ganton garage"));
        garages.add(new Garage(0, new Location(-364.439, 1194.37, 18.597), "cn2gar1", "Fort Carson garage"));
        garages.add(new Garage(0, new Location(430.059, 2542.31, 15.166), "cn2gar2", "Verdant Meadows garage"));
        ...
        garages.add(new Garage(0, new Location(383.843, 2433.28, 15.166), "dhangar", "Verdant Meadows hangar"));
        ...
        garages.add(new Garage(0, new Location(-2043.1, 118.609, 27.821), "hbgdSFS", "main Doherty garage"));
        garages.add(new Garage(0, new Location(1523.92, -1653.23, 4.72837), "imp_la", "Los Santos impound lot"));
        garages.add(new Garage(0, new Location(-1652.78, 647.502, -6.04924), "imp_sf", "San Fierro impound lot"));
        garages.add(new Garage(0, new Location(2218.06, 2448.06, -8.43807), "imp_lv", "Las Venturas impound lot"));
        ...
        garages.add(new Garage(0, new Location(-2728.53, 212.295, 3.45112), "mds1SFS", "Wheels Arch Angel"));
        ...
        garages.add(new Garage(0, new Location(2640.78, -2049.99, 12.543), "modlast", "Loco Low Co"));
        garages.add(new Garage(0, new Location(-2108.92, 886.553, 75.566), "sav1sfe", "Calton Heights garage"));
        garages.add(new Garage(0, new Location(-2699.12, 821.489, 49.0042), "sav1sfw", "Paradiso garage"));
        garages.add(new Garage(0, new Location(2056.6, -1835.9, 12.5443), "sprLAE", "Idlewood Pay n Spray"));
        //garages.add(new Garage(0, new Location(1021.81, -1018.71, 30.9081), "sprLAe", "Temple Pay n Spray")); name maybe invalid? duplicate!
        ...
        garages.add(new Garage(0, new Location(-2454.02, -131.556, 25.0886), "svgsfs1", "Hashbury garage"));
        ...
        garages.add(new Garage(0, new Location(2449.5, 695.018, 10.4742), "vEsvgrg", "Rockshore West garage"));
        garages.add(new Garage(0, new Location(2602.6, 1438.84, 9.8337), "vgElock", "Las Venturas burglary garage"));
        garages.add(new Garage(0, new Location(1550.98, 1155.36, 8.97329), "vgshngr", "AT 400 hangar"));
    }
}
